...
* [NASA Open Source Rover](https://github.com/nasa-jpl/open-source-rover) ⭐ 9,587 | 🐛 18 | 🌐 Prolog | 📅 2026-08-13 - A build-it-yourself, 6-wheel rover based on the rovers on Mars. Licence: Apache 2.0.
...
* [DonkeyCar](https://github.com/autorope/donkeycar) ⭐ 3,492 | 🐛 134 | 🌐 Python | 📅 2026-08-17 - DIY self-driving platform for small scale cars. Requires an R/C car, Raspberry Pi and is programmed in Python. Licence: MIT.
* [OpenRobot](https://github.com/intel-isl/OpenBot) ⭐ 3,380 | 🐛 35 | 🌐 Swift | 📅 2026-08-12 - $50 robot car that interfaces with smartphone for high level control. Licence: MIT.
* [LeKiwi](https://github.com/SIGRobotics-UIUC/LeKiwi) ⭐ 1,387 | 🐛 12 | 📅 2026-08-05 - small omnidirectional robot with an [SO-ARM100](https://github.com/TheRobotStudio/SO-ARM100) ⭐ 7,134 | 🐛 81 | 📅 2026-08-05 attached to it. Licence: Apache 2.0.
...
* [SO-ARM100](https://github.com/TheRobotStudio/SO-ARM100) ⭐ 7,134 | 🐛 81 | 📅 2026-08-05 - Open Source 3D printable low-cost robot arm for accessible end-to-end learning. Licence: Apache 2.0.
...
* [Sesame Robot](https://github.com/dorianborian/sesame-robot/) ⭐ 3,993 | 🐛 16 | 🌐 C | 📅 2026-08-14 - ESP32-based low-cost quadruped robot. Locence: Apache 2.0.
...
* [Stanford Quadruped (Pupper)](https://github.com/stanfordroboticsclub/StanfordQuadruped) ⭐ 1,780 | 🐛 25 | 🌐 Python | 📅 2024-10-24 - A low cost quadruped robot with the BoM coming to around $600-900 depending on what components you already have. Licence: MIT.
...
* [Open Duck Mini v2](https://github.com/apirrone/Open_Duck_Mini) ⭐ 3,495 | 🐛 24 | 🌐 Python | 📅 2026-01-31 - A miniaturized version of Disney's BDX droid. Licence: Apache 2.0.
...
* [bam](https://github.com/Rhoban/bam) ⭐ 249 | 🐛 11 | 🌐 Python | 📅 2026-08-12 - A handy tool for characterizing actuator friction for better modeling for simulations. Licence: MIT.
...
* [Open MCT](https://github.com/nasa/openmct) ⭐ 13,084 | 🐛 1,068 | 🌐 JavaScript | 📅 2026-08-18 - Open MCT (Open Mission Control Technologies) is a next-generation mission control framework for visualization of data on desktop and mobile devices. It is developed at NASA's Ames Research Center, and is being used by NASA for data analysis of spacecraft missions, as well as planning and operation of experimental rover systems. Licence: Apache 2.0.
...
* [DIY-CNC-machine](https://github.com/maxvfischer/DIY-CNC-machine) ⭐ 1,953 | 🐛 2 | 📅 2022-02-04 - A very thorough DIY build of a CNC machine based on a Makita router with a very permissive licence.
...
* [Segment Anything](https://github.com/facebookresearch/segment-anything) ⭐ 54,700 | 🐛 594 | 🌐 Jupyter Notebook | 📅 2024-09-18 - The Segment Anything Model (SAM) produces high quality object masks from input prompts such as points or boxes, and it can be used to generate masks for all objects in an image. Licence: Apache 2.0.
* [openpose](https://github.com/CMU-Perceptual-Computing-Lab/openpose) ⭐ 34,371 | 🐛 359 | 🌐 C++ | 📅 2024-08-03 - Real-time multi-person keypoint detection library for body, face, hands, and foot estimation. Licence: permissible for non-profits and research organizations, commercial for for profit companies.
* [LeRobot](https://github.com/huggingface/lerobot) ⭐ 26,739 | 🐛 801 | 🌐 Python | 📅 2026-08-18 - Developped by Hugging Face, LeRobot provides models, datasets and tools for real-world robotics in PyTorch. Licence: Apache 2.0.
* [LiveKit](https://github.com/livekit/livekit) ⭐ 20,414 | 🐛 182 | 🌐 Go | 📅 2026-08-18 - LiveKit is an open-source WebRTC SFU & SDKs to enable low-latency realtime streaming of video, audio, & data.  SDKs available in [Rust](https://github.com/livekit/rust-sdks) ⭐ 478 | 🐛 112 | 🌐 Assembly | 📅 2026-08-18, [Python](https://github.com/livekit/python-sdks) ⭐ 377 | 🐛 41 | 🌐 Python | 📅 2026-08-17, [C++](https://github.com/livekit/client-sdk-cpp) ⭐ 67 | 🐛 12 | 🌐 C++ | 📅 2026-08-12, [Javascript](https://github.com/livekit/client-sdk-js) ⭐ 647 | 🐛 60 | 🌐 TypeScript | 📅 2026-08-18, [Swift](https://github.com/livekit/client-sdk-swift) ⭐ 439 | 🐛 26 | 🌐 Swift | 📅 2026-08-18, [Kotlin](https://github.com/livekit/client-sdk-android) ⭐ 349 | 🐛 79 | 🌐 Kotlin | 📅 2026-08-18, [Unity](https://github.com/livekit/client-sdk-unity) ⭐ 93 | 🐛 30 | 🌐 C# | 📅 2026-08-14, [Flutter](https://github.com/livekit/client-sdk-flutter) ⭐ 414 | 🐛 70 | 🌐 Dart | 📅 2026-08-18, [ESP32](https://github.com/livekit/client-sdk-esp32) ⭐ 145 | 🐛 14 | 🌐 C | 📅 2026-08-10.  License: Apache 2.0.
* [Open3D](https://github.com/isl-org/Open3D) ⭐ 13,893 | 🐛 1,346 | 🌐 C++ | 📅 2026-08-18 - an open-source library that supports rapid development of software that deals with 3D data. The Open3D frontend exposes a set of carefully selected data structures and algorithms in both C++ and Python. Licence: MIT.
* [Rerun](https://github.com/rerun-io/rerun) ⭐ 11,319 | 🐛 1,267 | 🌐 Rust | 📅 2026-08-18 - An SDK for logging computer vision and robotics data paired with a visualizer for exploring that data over time. It lets you debug and understand the internal state and data of your systems with minimal code. Licence: Dual licence under MIT OR Apache-2.0.
...
* [pinocchio](https://github.com/stack-of-tasks/pinocchio) ⭐ 3,659 | 🐛 107 | 🌐 C++ | 📅 2026-08-11 - a fast and flexible implementation of Rigid Body Dynamics algorithms and their analytical derivatives. Licence: BSD-2 Clause.
* [GTSAM](https://github.com/borglab/gtsam) ⭐ 3,638 | 🐛 22 | 🌐 Jupyter Notebook | 📅 2026-08-18 - a BSD-licensed C++ library that implements sensor fusion for robotics and computer vision applications, including SLAM (Simultaneous Localization and Mapping), VO (Visual Odometry), and SFM (Structure from Motion). It uses factor graphs and Bayes networks as the underlying computing paradigm rather than sparse matrices to optimize for the most probable configuration or an optimal plan. Licence: BSD.
* [Robotics Toolbox for Python](https://github.com/petercorke/robotics-toolbox-python) ⭐ 3,388 | 🐛 113 | 🌐 C++ | 📅 2026-08-18 - this toolbox brings robotics-specific functionality to Python, and leverages Python's advantages of portability, ubiquity and support, and the capability of the open-source ecosystem for linear algebra (numpy, scipy), graphics (matplotlib, three.js, WebGL), interactive development (jupyter, jupyterlab, mybinder.org), and documentation (sphinx). Licence: MIT.
...
* [Crocoddyl](https://github.com/loco-3d/crocoddyl) ⭐ 1,278 | 🐛 19 | 🌐 C++ | 📅 2026-08-18 - an optimal control library for robot control under contact sequence. Its solver is based on various efficient Differential Dynamic Programming (DDP)-like algorithms. Licence: BSD 3-Clause.
...
* [Fields2Cover](https://github.com/Fields2Cover/Fields2Cover) ⭐ 867 | 🐛 31 | 🌐 C++ | 📅 2026-08-18 - A modular and extensible Coverage Path Planning library. Licence: BSD-3-Clause.
...
* [Cartographer](https://github.com/googlecartographer/cartographer) ⭐ 7,948 | 🐛 242 | 🌐 C++ | 📅 2024-01-05 - 2D and 3D SLAM library, supports multiple platforms and sensor configurations. Licence: Apache 2.0.
...
* [AirSim](https://github.com/microsoft/AirSim) ⭐ 18,408 | 🐛 780 | 🌐 C++ | 📅 2026-06-30 - A simulator for drones, cars and more, built on Unreal Engine and made by Microsoft. Licence: MIT.
* [Flightmare](https://github.com/uzh-rpg/flightmare) ⭐ 1,403 | 🐛 128 | 🌐 C++ | 📅 2024-06-14 - An Open Flexible Quadrotor Simulator. Licence: MIT.
...
* [DORA](https://github.com/dora-rs/dora) ⭐ 3,884 | 🐛 78 | 🌐 Rust | 📅 2026-08-18 - middleware designed to streamline and simplify the creation of AI-based robotic applications. Licence: Apache 2.0.
* [Copper](https://github.com/copper-project/copper-rs) ⭐ 1,456 | 🐛 28 | 🌐 Rust | 📅 2026-08-15 - Copper is a user-friendly runtime engine for creating fast and reliable robots. Copper is to robots what a game engine is to games. Licence: Apache 2.0.
* [YARP](https://github.com/robotology/yarp) ⭐ 602 | 🐛 251 | 🌐 C++ | 📅 2026-08-18 - Yet Another Robot Platform middleware for robotics.
...
* [PlotJuggler](https://github.com/facontidavide/PlotJuggler) ⭐ 6,119 | 🐛 157 | 🌐 C++ | 📅 2026-08-10 - QT5 based application to display time series in plots, using an intuitive "drag and drop" interface. Licence: GPLv3.
* [BehaviourTree.CPP](https://github.com/BehaviorTree/BehaviorTree.CPP) ⭐ 4,162 | 🐛 56 | 🌐 C++ | 📅 2026-08-14 - Behavior Trees Library in C++. Licence: MIT.
...
* [Aerostack2](https://github.com/aerostack2/aerostack2) ⭐ 374 | 🐛 74 | 🌐 C++ | 📅 2026-08-18 - framework that helps developers design and build the control architecture of aerial robotic systems. Licence: BSD 3-Clause.
...
* [FusionCore](https://github.com/manankharwar/fusioncore) ⭐ 312 | 🐛 31 | 🌐 C++ | 📅 2026-08-18 - ROS 2 UKF sensor fusion for IMU, wheel encoders and GPS. 22-state filter with ECEF-native GPS handling, automatic IMU bias estimation, adaptive noise covariance and chi-squared outlier rejection on every sensor. Benchmarked against robot\_localization EKF on 6 NCLT public dataset sequences. Licence: Apache 2.0.
* [ros2\_medkit](https://github.com/selfpatch/ros2_medkit) ⭐ 250 | 🐛 68 | 🌐 C++ | 📅 2026-08-17 - Structured fault management for ROS 2 — persistent fault lifecycle, REST/SSE API, root cause correlation, and automatic rosbag capture on fault. Inspired by SOVD (Service-Oriented Vehicle Diagnostics), the ASAM standard that brings HTTP/REST diagnostics to automotive and robotics. Licence: Apache 2.0.
...
* [WireViz](https://github.com/formatc1702/WireViz) ⭐ 5,225 | 🐛 193 | 🌐 Python | 📅 2026-06-06 - A tool for documenting cables, wiring harnesses and connector pinouts by describing them in YAML format. Licence: GPLv3.0.

## Books and Courses

* [PythonRobotics](https://github.com/AtsushiSakai/PythonRobotics) ⭐ 30,319 | 🐛 50 | 🌐 Python | 📅 2026-08-17 - Python sample codes for robotics algorithms. Licence: MIT.
* [Kalman and Bayesian Filters in Python](https://github.com/rlabbe/Kalman-and-Bayesian-Filters-in-Python) ⭐ 19,210 | 🐛 143 | 🌐 Jupyter Notebook | 📅 2024-08-07 - Kalman Filter book using Jupyter Notebook. Focuses on building intuition and experience, not formal proofs. Includes Kalman filters, extended Kalman filters, unscented Kalman filters, particle filters, and more. All exercises include solutions. Licence: CC.
...
* [Robotics 501: Mathematics for Robotics](https://github.com/michiganrobotics/rob501) ⭐ 2,843 | 🐛 1 | 📅 2022-03-21 - ROB 501: Mathematics for Robotics, is a graduate-level course at the University of Michigan that introduces applied mathematics for robotics engineers.
...
* [kiloreux](https://github.com/kiloreux/awesome-robotics) ⭐ 6,960 | 🐛 37 | 📅 2024-09-22
...
* [jslee02](https://github.com/jslee02/awesome-robotics-libraries/blob/master/README.md) ⭐ 3,017 | 🐛 14 | 🌐 Python | 📅 2026-08-06
