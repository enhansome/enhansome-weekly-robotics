...
* [OpenRobot](https://github.com/intel-isl/OpenBot) ⭐ 3,443 | 🐛 34 | 🌐 Swift | 📅 2026-08-26 - $50 robot car that interfaces with smartphone for high level control. Licence: MIT.
* [LeKiwi](https://github.com/SIGRobotics-UIUC/LeKiwi) ⭐ 1,393 | 🐛 12 | 📅 2026-08-05 - small omnidirectional robot with an [SO-ARM100](https://github.com/TheRobotStudio/SO-ARM100) ⭐ 7,201 | 🐛 83 | 📅 2026-08-05 attached to it. Licence: Apache 2.0.
...
* [SO-ARM100](https://github.com/TheRobotStudio/SO-ARM100) ⭐ 7,201 | 🐛 83 | 📅 2026-08-05 - Open Source 3D printable low-cost robot arm for accessible end-to-end learning. Licence: Apache 2.0.
...
* [Sesame Robot](https://github.com/dorianborian/sesame-robot/) ⭐ 4,163 | 🐛 16 | 🌐 C | 📅 2026-08-23 - ESP32-based low-cost quadruped robot. Locence: Apache 2.0.
* [Stanford Doggo](https://github.com/Nate711/StanfordDoggoProject) ⭐ 2,550 | 🐛 11 | 📅 2024-07-08 - Stanford Doggo is a highly agile robot designed to provide an accessible platform for legged robot research. Licence: MIT.
* [Stanford Quadruped (Pupper)](https://github.com/stanfordroboticsclub/StanfordQuadruped) ⭐ 1,783 | 🐛 25 | 🌐 Python | 📅 2024-10-24 - A low cost quadruped robot with the BoM coming to around $600-900 depending on what components you already have. Licence: MIT.
* [mjbots quad A0](https://github.com/mjbots/moteus) ⭐ 1,270 | 🐛 1 | 🌐 C++ | 📅 2026-08-25 - The mjbots quad A0 is a small dynamic quadruped, like the MIT mini-Cheetah, but fully open source. Licence: Apache 2.0.
...
* [Open Duck Mini v2](https://github.com/apirrone/Open_Duck_Mini) ⭐ 3,522 | 🐛 25 | 🌐 Python | 📅 2026-01-31 - A miniaturized version of Disney's BDX droid. Licence: Apache 2.0.
...
* [Open MCT](https://github.com/nasa/openmct) ⭐ 13,095 | 🐛 1,072 | 🌐 JavaScript | 📅 2026-08-26 - Open MCT (Open Mission Control Technologies) is a next-generation mission control framework for visualization of data on desktop and mobile devices. It is developed at NASA's Ames Research Center, and is being used by NASA for data analysis of spacecraft missions, as well as planning and operation of experimental rover systems. Licence: Apache 2.0.
...
* [Segment Anything](https://github.com/facebookresearch/segment-anything) ⭐ 54,761 | 🐛 595 | 🌐 Jupyter Notebook | 📅 2024-09-18 - The Segment Anything Model (SAM) produces high quality object masks from input prompts such as points or boxes, and it can be used to generate masks for all objects in an image. Licence: Apache 2.0.
* [openpose](https://github.com/CMU-Perceptual-Computing-Lab/openpose) ⭐ 34,414 | 🐛 359 | 🌐 C++ | 📅 2024-08-03 - Real-time multi-person keypoint detection library for body, face, hands, and foot estimation. Licence: permissible for non-profits and research organizations, commercial for for profit companies.
* [LeRobot](https://github.com/huggingface/lerobot) ⭐ 26,959 | 🐛 827 | 🌐 Python | 📅 2026-08-26 - Developped by Hugging Face, LeRobot provides models, datasets and tools for real-world robotics in PyTorch. Licence: Apache 2.0.
* [LiveKit](https://github.com/livekit/livekit) ⭐ 20,532 | 🐛 187 | 🌐 Go | 📅 2026-08-26 - LiveKit is an open-source WebRTC SFU & SDKs to enable low-latency realtime streaming of video, audio, & data.  SDKs available in [Rust](https://github.com/livekit/rust-sdks) ⭐ 483 | 🐛 123 | 🌐 Assembly | 📅 2026-08-27, [Python](https://github.com/livekit/python-sdks) ⭐ 380 | 🐛 44 | 🌐 Python | 📅 2026-08-26, [C++](https://github.com/livekit/client-sdk-cpp) ⭐ 67 | 🐛 10 | 🌐 C++ | 📅 2026-08-26, [Javascript](https://github.com/livekit/client-sdk-js) ⭐ 649 | 🐛 59 | 🌐 TypeScript | 📅 2026-08-26, [Swift](https://github.com/livekit/client-sdk-swift) ⭐ 441 | 🐛 30 | 🌐 Swift | 📅 2026-08-26, [Kotlin](https://github.com/livekit/client-sdk-android) ⭐ 355 | 🐛 83 | 🌐 Kotlin | 📅 2026-08-26, [Unity](https://github.com/livekit/client-sdk-unity) ⭐ 93 | 🐛 35 | 🌐 C# | 📅 2026-08-26, [Flutter](https://github.com/livekit/client-sdk-flutter) ⭐ 416 | 🐛 72 | 🌐 Dart | 📅 2026-08-26, [ESP32](https://github.com/livekit/client-sdk-esp32) ⭐ 146 | 🐛 15 | 🌐 C | 📅 2026-08-21.  License: Apache 2.0.
* [Open3D](https://github.com/isl-org/Open3D) ⭐ 13,913 | 🐛 1,309 | 🌐 C++ | 📅 2026-08-26 - an open-source library that supports rapid development of software that deals with 3D data. The Open3D frontend exposes a set of carefully selected data structures and algorithms in both C++ and Python. Licence: MIT.
* [Rerun](https://github.com/rerun-io/rerun) ⭐ 11,364 | 🐛 1,275 | 🌐 Rust | 📅 2026-08-26 - An SDK for logging computer vision and robotics data paired with a visualizer for exploring that data over time. It lets you debug and understand the internal state and data of your systems with minimal code. Licence: Dual licence under MIT OR Apache-2.0.
...
* [Crocoddyl](https://github.com/loco-3d/crocoddyl) ⭐ 1,286 | 🐛 20 | 🌐 C++ | 📅 2026-08-26 - an optimal control library for robot control under contact sequence. Its solver is based on various efficient Differential Dynamic Programming (DDP)-like algorithms. Licence: BSD 3-Clause.
...
* [Fields2Cover](https://github.com/Fields2Cover/Fields2Cover) ⭐ 874 | 🐛 33 | 🌐 C++ | 📅 2026-08-25 - A modular and extensible Coverage Path Planning library. Licence: BSD-3-Clause.
...
* [Cartographer](https://github.com/googlecartographer/cartographer) ⭐ 7,949 | 🐛 242 | 🌐 C++ | 📅 2024-01-05 - 2D and 3D SLAM library, supports multiple platforms and sensor configurations. Licence: Apache 2.0.
* [LIO-SAM](https://github.com/TixiaoShan/LIO-SAM) ⭐ 4,894 | 🐛 183 | 🌐 C++ | 📅 2025-02-14 - A real-time lidar-inertial odometry package with very promising results for multi-beam LiDARS. Licence: BSD-3 Clause.
...
* [AirSim](https://github.com/microsoft/AirSim) ⭐ 18,424 | 🐛 780 | 🌐 C++ | 📅 2026-06-30 - A simulator for drones, cars and more, built on Unreal Engine and made by Microsoft. Licence: MIT.
...
* [DORA](https://github.com/dora-rs/dora) ⭐ 3,901 | 🐛 108 | 🌐 Rust | 📅 2026-08-27 - middleware designed to streamline and simplify the creation of AI-based robotic applications. Licence: Apache 2.0.
* [Copper](https://github.com/copper-project/copper-rs) ⭐ 1,467 | 🐛 28 | 🌐 Rust | 📅 2026-08-26 - Copper is a user-friendly runtime engine for creating fast and reliable robots. Copper is to robots what a game engine is to games. Licence: Apache 2.0.
* [YARP](https://github.com/robotology/yarp) ⭐ 602 | 🐛 252 | 🌐 C++ | 📅 2026-08-25 - Yet Another Robot Platform middleware for robotics.
...
* [PlotJuggler](https://github.com/facontidavide/PlotJuggler) ⭐ 6,127 | 🐛 161 | 🌐 C++ | 📅 2026-08-10 - QT5 based application to display time series in plots, using an intuitive "drag and drop" interface. Licence: GPLv3.
...
* [Astrobee Robot Software](https://github.com/nasa/astrobee) ⭐ 1,397 | 🐛 32 | 🌐 C++ | 📅 2025-12-02 - NASA Astrobee Robot Software. Licence: Apache v2.0.
...
* [Aerostack2](https://github.com/aerostack2/aerostack2) ⭐ 377 | 🐛 72 | 🌐 C++ | 📅 2026-08-25 - framework that helps developers design and build the control architecture of aerial robotic systems. Licence: BSD 3-Clause.
...
* [PythonRobotics](https://github.com/AtsushiSakai/PythonRobotics) ⭐ 30,388 | 🐛 51 | 🌐 Python | 📅 2026-08-24 - Python sample codes for robotics algorithms. Licence: MIT.
* [Kalman and Bayesian Filters in Python](https://github.com/rlabbe/Kalman-and-Bayesian-Filters-in-Python) ⭐ 19,220 | 🐛 143 | 🌐 Jupyter Notebook | 📅 2024-08-07 - Kalman Filter book using Jupyter Notebook. Focuses on building intuition and experience, not formal proofs. Includes Kalman filters, extended Kalman filters, unscented Kalman filters, particle filters, and more. All exercises include solutions. Licence: CC.
...
* [Robotics 501: Mathematics for Robotics](https://github.com/michiganrobotics/rob501) ⭐ 2,867 | 🐛 1 | 📅 2022-03-21 - ROB 501: Mathematics for Robotics, is a graduate-level course at the University of Michigan that introduces applied mathematics for robotics engineers.
...
* [kiloreux](https://github.com/kiloreux/awesome-robotics) ⭐ 6,982 | 🐛 38 | 📅 2024-09-22
...
* [jslee02](https://github.com/jslee02/awesome-robotics-libraries/blob/master/README.md) ⭐ 3,026 | 🐛 17 | 🌐 Python | 📅 2026-08-25
...
* [Best of Robot Simulators](https://github.com/knmcguire/best-of-robot-simulators) ⭐ 1,447 | 🐛 24 | 📅 2026-08-26
