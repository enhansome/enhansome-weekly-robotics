...
* [OpenRobot](https://github.com/intel-isl/OpenBot) ⭐ 3,424 | 🐛 35 | 🌐 Swift | 📅 2026-08-22 - $50 robot car that interfaces with smartphone for high level control. Licence: MIT.
* [LeKiwi](https://github.com/SIGRobotics-UIUC/LeKiwi) ⭐ 1,392 | 🐛 12 | 📅 2026-08-05 - small omnidirectional robot with an [SO-ARM100](https://github.com/TheRobotStudio/SO-ARM100) ⭐ 7,174 | 🐛 82 | 📅 2026-08-05 attached to it. Licence: Apache 2.0.
...
* [SO-ARM100](https://github.com/TheRobotStudio/SO-ARM100) ⭐ 7,174 | 🐛 82 | 📅 2026-08-05 - Open Source 3D printable low-cost robot arm for accessible end-to-end learning. Licence: Apache 2.0.
...
* [Sesame Robot](https://github.com/dorianborian/sesame-robot/) ⭐ 4,078 | 🐛 16 | 🌐 C | 📅 2026-08-14 - ESP32-based low-cost quadruped robot. Locence: Apache 2.0.
...
* [Open Duck Mini v2](https://github.com/apirrone/Open_Duck_Mini) ⭐ 3,511 | 🐛 25 | 🌐 Python | 📅 2026-01-31 - A miniaturized version of Disney's BDX droid. Licence: Apache 2.0.
* [Poppy Humanoid](https://github.com/poppy-project/poppy-humanoid) ⭐ 1,046 | 🐛 4 | 🌐 Jupyter Notebook | 📅 2021-12-06 - An open-source and 3D printed humanoid robot. Licence: Hardware CC BY-SA, Software: GPL v3.
...
* [Open MCT](https://github.com/nasa/openmct) ⭐ 13,090 | 🐛 1,074 | 🌐 JavaScript | 📅 2026-08-23 - Open MCT (Open Mission Control Technologies) is a next-generation mission control framework for visualization of data on desktop and mobile devices. It is developed at NASA's Ames Research Center, and is being used by NASA for data analysis of spacecraft missions, as well as planning and operation of experimental rover systems. Licence: Apache 2.0.
...
* [DIY-CNC-machine](https://github.com/maxvfischer/DIY-CNC-machine) ⭐ 2,004 | 🐛 2 | 📅 2022-02-04 - A very thorough DIY build of a CNC machine based on a Makita router with a very permissive licence.
...
* [Segment Anything](https://github.com/facebookresearch/segment-anything) ⭐ 54,743 | 🐛 595 | 🌐 Jupyter Notebook | 📅 2024-09-18 - The Segment Anything Model (SAM) produces high quality object masks from input prompts such as points or boxes, and it can be used to generate masks for all objects in an image. Licence: Apache 2.0.
* [openpose](https://github.com/CMU-Perceptual-Computing-Lab/openpose) ⭐ 34,386 | 🐛 359 | 🌐 C++ | 📅 2024-08-03 - Real-time multi-person keypoint detection library for body, face, hands, and foot estimation. Licence: permissible for non-profits and research organizations, commercial for for profit companies.
* [LeRobot](https://github.com/huggingface/lerobot) ⭐ 26,851 | 🐛 817 | 🌐 Python | 📅 2026-08-23 - Developped by Hugging Face, LeRobot provides models, datasets and tools for real-world robotics in PyTorch. Licence: Apache 2.0.
* [LiveKit](https://github.com/livekit/livekit) ⭐ 20,490 | 🐛 182 | 🌐 Go | 📅 2026-08-22 - LiveKit is an open-source WebRTC SFU & SDKs to enable low-latency realtime streaming of video, audio, & data.  SDKs available in [Rust](https://github.com/livekit/rust-sdks) ⭐ 480 | 🐛 117 | 🌐 Assembly | 📅 2026-08-23, [Python](https://github.com/livekit/python-sdks) ⭐ 379 | 🐛 45 | 🌐 Python | 📅 2026-08-23, [C++](https://github.com/livekit/client-sdk-cpp) ⭐ 67 | 🐛 16 | 🌐 C++ | 📅 2026-08-21, [Javascript](https://github.com/livekit/client-sdk-js) ⭐ 648 | 🐛 60 | 🌐 TypeScript | 📅 2026-08-21, [Swift](https://github.com/livekit/client-sdk-swift) ⭐ 439 | 🐛 30 | 🌐 Swift | 📅 2026-08-21, [Kotlin](https://github.com/livekit/client-sdk-android) ⭐ 351 | 🐛 84 | 🌐 Kotlin | 📅 2026-08-20, [Unity](https://github.com/livekit/client-sdk-unity) ⭐ 93 | 🐛 30 | 🌐 C# | 📅 2026-08-14, [Flutter](https://github.com/livekit/client-sdk-flutter) ⭐ 415 | 🐛 71 | 🌐 Dart | 📅 2026-08-18, [ESP32](https://github.com/livekit/client-sdk-esp32) ⭐ 145 | 🐛 15 | 🌐 C | 📅 2026-08-21.  License: Apache 2.0.
* [Open3D](https://github.com/isl-org/Open3D) ⭐ 13,908 | 🐛 1,314 | 🌐 C++ | 📅 2026-08-23 - an open-source library that supports rapid development of software that deals with 3D data. The Open3D frontend exposes a set of carefully selected data structures and algorithms in both C++ and Python. Licence: MIT.
* [Rerun](https://github.com/rerun-io/rerun) ⭐ 11,340 | 🐛 1,274 | 🌐 Rust | 📅 2026-08-21 - An SDK for logging computer vision and robotics data paired with a visualizer for exploring that data over time. It lets you debug and understand the internal state and data of your systems with minimal code. Licence: Dual licence under MIT OR Apache-2.0.
...
* [pinocchio](https://github.com/stack-of-tasks/pinocchio) ⭐ 3,677 | 🐛 111 | 🌐 C++ | 📅 2026-08-11 - a fast and flexible implementation of Rigid Body Dynamics algorithms and their analytical derivatives. Licence: BSD-2 Clause.
* [GTSAM](https://github.com/borglab/gtsam) ⭐ 3,646 | 🐛 7 | 🌐 Jupyter Notebook | 📅 2026-08-23 - a BSD-licensed C++ library that implements sensor fusion for robotics and computer vision applications, including SLAM (Simultaneous Localization and Mapping), VO (Visual Odometry), and SFM (Structure from Motion). It uses factor graphs and Bayes networks as the underlying computing paradigm rather than sparse matrices to optimize for the most probable configuration or an optimal plan. Licence: BSD.
* [Robotics Toolbox for Python](https://github.com/petercorke/robotics-toolbox-python) ⭐ 3,431 | 🐛 111 | 🌐 C++ | 📅 2026-08-22 - this toolbox brings robotics-specific functionality to Python, and leverages Python's advantages of portability, ubiquity and support, and the capability of the open-source ecosystem for linear algebra (numpy, scipy), graphics (matplotlib, three.js, WebGL), interactive development (jupyter, jupyterlab, mybinder.org), and documentation (sphinx). Licence: MIT.
* [Open Motion Planning Library](https://github.com/ompl/ompl) ⭐ 2,132 | 🐛 99 | 🌐 C++ | 📅 2026-08-14 - OMPL consists of many state-of-the-art sampling-based motion planning algorithms. Licence: BSD-3 Clause.
...
* [Fields2Cover](https://github.com/Fields2Cover/Fields2Cover) ⭐ 870 | 🐛 35 | 🌐 C++ | 📅 2026-08-23 - A modular and extensible Coverage Path Planning library. Licence: BSD-3-Clause.
...
* [AirSim](https://github.com/microsoft/AirSim) ⭐ 18,418 | 🐛 780 | 🌐 C++ | 📅 2026-06-30 - A simulator for drones, cars and more, built on Unreal Engine and made by Microsoft. Licence: MIT.
* [Flightmare](https://github.com/uzh-rpg/flightmare) ⭐ 1,405 | 🐛 128 | 🌐 C++ | 📅 2024-06-14 - An Open Flexible Quadrotor Simulator. Licence: MIT.
...
* [DORA](https://github.com/dora-rs/dora) ⭐ 3,893 | 🐛 71 | 🌐 Rust | 📅 2026-08-23 - middleware designed to streamline and simplify the creation of AI-based robotic applications. Licence: Apache 2.0.
...
* [YARP](https://github.com/robotology/yarp) ⭐ 602 | 🐛 251 | 🌐 C++ | 📅 2026-08-23 - Yet Another Robot Platform middleware for robotics.
...
* [Wavemap](https://github.com/ethz-asl/wavemap) ⭐ 569 | 🐛 12 | 🌐 C++ | 📅 2024-12-30 - Fast, efficient and accurate multi-resolution, multi-sensor 3D occupancy mapping. Licence: BSD 3-Clause.
...
* [ODrive](https://odriverobotics.com/) - "A hobby motor for robotics". Can control two motors at the same time. Licence: MIT ([Hardware](https://github.com/madcowswe/ODriveHardware) ⭐ 1,085 | 🐛 9 | 🌐 Verilog | 📅 2022-05-13, [Software](https://github.com/madcowswe/ODrive/blob/master/LICENSE.md) ⭐ 3,739 | 🐛 18 | 🌐 C++ | 📅 2026-01-20).
...
* [PythonRobotics](https://github.com/AtsushiSakai/PythonRobotics) ⭐ 30,351 | 🐛 50 | 🌐 Python | 📅 2026-08-17 - Python sample codes for robotics algorithms. Licence: MIT.
...
* [kiloreux](https://github.com/kiloreux/awesome-robotics) ⭐ 6,977 | 🐛 37 | 📅 2024-09-22
...
* [Best of Robot Simulators](https://github.com/knmcguire/best-of-robot-simulators) ⭐ 1,437 | 🐛 19 | 📅 2026-08-19
