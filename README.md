...
* [NASA Open Source Rover](https://github.com/nasa-jpl/open-source-rover) ⭐ 9,599 | 🐛 16 | 🌐 Prolog | 📅 2026-08-13 - A build-it-yourself, 6-wheel rover based on the rovers on Mars. Licence: Apache 2.0.
* [OpenMower](https://github.com/ClemensElflein/OpenMower) ⭐ 6,678 | 🐛 12 | 🌐 Shell | 📅 2026-08-14 - an open-source, RTK-GPS enabled mower project. Licence: CC BY-NC-SA 4.0.
...
* [OpenRobot](https://github.com/intel-isl/OpenBot) ⭐ 3,418 | 🐛 35 | 🌐 Swift | 📅 2026-08-22 - $50 robot car that interfaces with smartphone for high level control. Licence: MIT.
* [LeKiwi](https://github.com/SIGRobotics-UIUC/LeKiwi) ⭐ 1,391 | 🐛 12 | 📅 2026-08-05 - small omnidirectional robot with an [SO-ARM100](https://github.com/TheRobotStudio/SO-ARM100) ⭐ 7,167 | 🐛 82 | 📅 2026-08-05 attached to it. Licence: Apache 2.0.
* [Linorobot](https://github.com/linorobot/linorobot) ⭐ 1,110 | 🐛 27 | 🌐 C++ | 📅 2023-05-10 - ROS Compatible ground robots (2WD, 4WD, Ackermann Steering, Mecanum Drive). Licence: BSD-2 Clause.
...
* [SO-ARM100](https://github.com/TheRobotStudio/SO-ARM100) ⭐ 7,167 | 🐛 82 | 📅 2026-08-05 - Open Source 3D printable low-cost robot arm for accessible end-to-end learning. Licence: Apache 2.0.
...
* [Sesame Robot](https://github.com/dorianborian/sesame-robot/) ⭐ 4,037 | 🐛 16 | 🌐 C | 📅 2026-08-14 - ESP32-based low-cost quadruped robot. Locence: Apache 2.0.
...
* [Open Duck Mini v2](https://github.com/apirrone/Open_Duck_Mini) ⭐ 3,508 | 🐛 25 | 🌐 Python | 📅 2026-01-31 - A miniaturized version of Disney's BDX droid. Licence: Apache 2.0.
* [Poppy Humanoid](https://github.com/poppy-project/poppy-humanoid) ⭐ 1,045 | 🐛 4 | 🌐 Jupyter Notebook | 📅 2021-12-06 - An open-source and 3D printed humanoid robot. Licence: Hardware CC BY-SA, Software: GPL v3.

## Actuators

* [bam](https://github.com/Rhoban/bam) ⭐ 253 | 🐛 11 | 🌐 Python | 📅 2026-08-12 - A handy tool for characterizing actuator friction for better modeling for simulations. Licence: MIT.
...
* [Open MCT](https://github.com/nasa/openmct) ⭐ 13,089 | 🐛 1,073 | 🌐 JavaScript | 📅 2026-08-20 - Open MCT (Open Mission Control Technologies) is a next-generation mission control framework for visualization of data on desktop and mobile devices. It is developed at NASA's Ames Research Center, and is being used by NASA for data analysis of spacecraft missions, as well as planning and operation of experimental rover systems. Licence: Apache 2.0.
...
* [DIY-CNC-machine](https://github.com/maxvfischer/DIY-CNC-machine) ⭐ 1,979 | 🐛 2 | 📅 2022-02-04 - A very thorough DIY build of a CNC machine based on a Makita router with a very permissive licence.
...
* [Segment Anything](https://github.com/facebookresearch/segment-anything) ⭐ 54,741 | 🐛 595 | 🌐 Jupyter Notebook | 📅 2024-09-18 - The Segment Anything Model (SAM) produces high quality object masks from input prompts such as points or boxes, and it can be used to generate masks for all objects in an image. Licence: Apache 2.0.
...
* [LeRobot](https://github.com/huggingface/lerobot) ⭐ 26,835 | 🐛 813 | 🌐 Python | 📅 2026-08-22 - Developped by Hugging Face, LeRobot provides models, datasets and tools for real-world robotics in PyTorch. Licence: Apache 2.0.
* [LiveKit](https://github.com/livekit/livekit) ⭐ 20,483 | 🐛 181 | 🌐 Go | 📅 2026-08-22 - LiveKit is an open-source WebRTC SFU & SDKs to enable low-latency realtime streaming of video, audio, & data.  SDKs available in [Rust](https://github.com/livekit/rust-sdks) ⭐ 480 | 🐛 117 | 🌐 Assembly | 📅 2026-08-22, [Python](https://github.com/livekit/python-sdks) ⭐ 379 | 🐛 45 | 🌐 Python | 📅 2026-08-22, [C++](https://github.com/livekit/client-sdk-cpp) ⭐ 67 | 🐛 16 | 🌐 C++ | 📅 2026-08-21, [Javascript](https://github.com/livekit/client-sdk-js) ⭐ 648 | 🐛 58 | 🌐 TypeScript | 📅 2026-08-21, [Swift](https://github.com/livekit/client-sdk-swift) ⭐ 439 | 🐛 30 | 🌐 Swift | 📅 2026-08-21, [Kotlin](https://github.com/livekit/client-sdk-android) ⭐ 351 | 🐛 83 | 🌐 Kotlin | 📅 2026-08-20, [Unity](https://github.com/livekit/client-sdk-unity) ⭐ 93 | 🐛 30 | 🌐 C# | 📅 2026-08-14, [Flutter](https://github.com/livekit/client-sdk-flutter) ⭐ 415 | 🐛 71 | 🌐 Dart | 📅 2026-08-18, [ESP32](https://github.com/livekit/client-sdk-esp32) ⭐ 145 | 🐛 15 | 🌐 C | 📅 2026-08-21.  License: Apache 2.0.
* [Open3D](https://github.com/isl-org/Open3D) ⭐ 13,906 | 🐛 1,318 | 🌐 C++ | 📅 2026-08-22 - an open-source library that supports rapid development of software that deals with 3D data. The Open3D frontend exposes a set of carefully selected data structures and algorithms in both C++ and Python. Licence: MIT.
* [Rerun](https://github.com/rerun-io/rerun) ⭐ 11,340 | 🐛 1,272 | 🌐 Rust | 📅 2026-08-21 - An SDK for logging computer vision and robotics data paired with a visualizer for exploring that data over time. It lets you debug and understand the internal state and data of your systems with minimal code. Licence: Dual licence under MIT OR Apache-2.0.
* [Ceres Solver](https://github.com/ceres-solver/ceres-solver) ⭐ 4,542 | 🐛 68 | 🌐 C++ | 📅 2026-08-19 - An open source C++ library for modeling and solving large, complicated optimization problems, used by many organizations for bundle adjustment, SLAM, camera calibration and many other robotics-based applications. Licence: BSD-3 Clause.
* [pinocchio](https://github.com/stack-of-tasks/pinocchio) ⭐ 3,675 | 🐛 110 | 🌐 C++ | 📅 2026-08-11 - a fast and flexible implementation of Rigid Body Dynamics algorithms and their analytical derivatives. Licence: BSD-2 Clause.
* [GTSAM](https://github.com/borglab/gtsam) ⭐ 3,644 | 🐛 12 | 🌐 Jupyter Notebook | 📅 2026-08-22 - a BSD-licensed C++ library that implements sensor fusion for robotics and computer vision applications, including SLAM (Simultaneous Localization and Mapping), VO (Visual Odometry), and SFM (Structure from Motion). It uses factor graphs and Bayes networks as the underlying computing paradigm rather than sparse matrices to optimize for the most probable configuration or an optimal plan. Licence: BSD.
* [Robotics Toolbox for Python](https://github.com/petercorke/robotics-toolbox-python) ⭐ 3,425 | 🐛 111 | 🌐 C++ | 📅 2026-08-22 - this toolbox brings robotics-specific functionality to Python, and leverages Python's advantages of portability, ubiquity and support, and the capability of the open-source ecosystem for linear algebra (numpy, scipy), graphics (matplotlib, three.js, WebGL), interactive development (jupyter, jupyterlab, mybinder.org), and documentation (sphinx). Licence: MIT.
...
* [Crocoddyl](https://github.com/loco-3d/crocoddyl) ⭐ 1,283 | 🐛 19 | 🌐 C++ | 📅 2026-08-18 - an optimal control library for robot control under contact sequence. Its solver is based on various efficient Differential Dynamic Programming (DDP)-like algorithms. Licence: BSD 3-Clause.
...
* [Fields2Cover](https://github.com/Fields2Cover/Fields2Cover) ⭐ 870 | 🐛 34 | 🌐 C++ | 📅 2026-08-22 - A modular and extensible Coverage Path Planning library. Licence: BSD-3-Clause.
...
* [LIO-SAM](https://github.com/TixiaoShan/LIO-SAM) ⭐ 4,892 | 🐛 183 | 🌐 C++ | 📅 2025-02-14 - A real-time lidar-inertial odometry package with very promising results for multi-beam LiDARS. Licence: BSD-3 Clause.
...
* [AirSim](https://github.com/microsoft/AirSim) ⭐ 18,416 | 🐛 780 | 🌐 C++ | 📅 2026-06-30 - A simulator for drones, cars and more, built on Unreal Engine and made by Microsoft. Licence: MIT.
...
* [DORA](https://github.com/dora-rs/dora) ⭐ 3,892 | 🐛 64 | 🌐 Rust | 📅 2026-08-22 - middleware designed to streamline and simplify the creation of AI-based robotic applications. Licence: Apache 2.0.
...
* [YARP](https://github.com/robotology/yarp) ⭐ 602 | 🐛 251 | 🌐 C++ | 📅 2026-08-22 - Yet Another Robot Platform middleware for robotics.
...
* [PlotJuggler](https://github.com/facontidavide/PlotJuggler) ⭐ 6,124 | 🐛 161 | 🌐 C++ | 📅 2026-08-10 - QT5 based application to display time series in plots, using an intuitive "drag and drop" interface. Licence: GPLv3.
...
* [Aerostack2](https://github.com/aerostack2/aerostack2) ⭐ 376 | 🐛 72 | 🌐 C++ | 📅 2026-08-19 - framework that helps developers design and build the control architecture of aerial robotic systems. Licence: BSD 3-Clause.
...
* [ODrive](https://odriverobotics.com/) - "A hobby motor for robotics". Can control two motors at the same time. Licence: MIT ([Hardware](https://github.com/madcowswe/ODriveHardware) ⭐ 1,085 | 🐛 9 | 🌐 Verilog | 📅 2022-05-13, [Software](https://github.com/madcowswe/ODrive/blob/master/LICENSE.md) ⭐ 3,738 | 🐛 18 | 🌐 C++ | 📅 2026-01-20).
...
* [WireViz](https://github.com/formatc1702/WireViz) ⭐ 5,228 | 🐛 195 | 🌐 Python | 📅 2026-06-06 - A tool for documenting cables, wiring harnesses and connector pinouts by describing them in YAML format. Licence: GPLv3.0.

## Books and Courses

* [PythonRobotics](https://github.com/AtsushiSakai/PythonRobotics) ⭐ 30,348 | 🐛 50 | 🌐 Python | 📅 2026-08-17 - Python sample codes for robotics algorithms. Licence: MIT.
...
* [Robotics 501: Mathematics for Robotics](https://github.com/michiganrobotics/rob501) ⭐ 2,861 | 🐛 1 | 📅 2022-03-21 - ROB 501: Mathematics for Robotics, is a graduate-level course at the University of Michigan that introduces applied mathematics for robotics engineers.
...
* [kiloreux](https://github.com/kiloreux/awesome-robotics) ⭐ 6,973 | 🐛 37 | 📅 2024-09-22
...
* [Awesome Robotics Projects](https://github.com/mjyc/awesome-robotics-projects) ⭐ 1,733 | 🐛 7 | 📅 2026-02-13
